    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('perpustakaan.view') }}"><i class="ti-more"></i>Tampilkan Perpustakaan</a></li>
            <li><a href="calendar.html"><i class="ti-more"></i>Perpustakaan View</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('mahasiswa.view') }}"><i class="ti-more"></i>Tampilkan Mahasiswa</a></li>
            <li><a href="calendar.html"><i class="ti-more"></i>Mahasiswa View</a></li>
		  </ul>
        </li>  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('hewan.view') }}"><i class="ti-more"></i>Tampilkan Hewan</a></li>
            <li><a href="calendar.html"><i class="ti-more"></i>Hewan</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="calendar.html"><i class="ti-more"></i>Tambah Kendaraan</a></li>
        </li>
